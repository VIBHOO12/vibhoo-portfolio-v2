...
//     achievements: [
//       "Built and shipped production React.js applications.",
//       "Developed 15+ reusable React components.",
//       "Integrated 18+ REST APIs using Axios.",
//       "Created responsive UI with Tailwind CSS.",
//       "Improved performance and fixed UI bugs.",
//     ],
//     current: true,
//   },
//   {
...
// const Experience = () => {
//   return (
//     <section id="experience" className="py-16 sm:py-20 lg:py-28 bg-gradient-to-b from-purple-50 to-white dark:from-gray-950 dark:to-gray-900">
//        <AnimatedBackground variant="soft" />
//       <div className="max-w-6xl mx-auto px-4 sm:px-6">
//         <div className="text-center mb-12 sm:mb-16 lg:mb-20">
//           <span className="uppercase tracking-[3px] sm:tracking-[5px] text-purple-600 font-semibold text-sm sm:text-base">
//             Experience
//           </span>
...
//             Building scalable frontend applications and gaining real-world production experience.
//           </p>
//         </div>

//         <div className="relative">
//           <div className="absolute left-5 sm:left-6 top-0 w-0.5 sm:w-1 h-full bg-purple-200 dark:bg-purple-900/50 rounded-full"></div>

//           {experiences.map((exp, index) => (
//             <div key={exp.company} className="relative pl-14 sm:pl-16 pb-10 sm:pb-16 last:pb-0">
//               <div className="absolute left-0 top-1 sm:top-2 w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-purple-700 border-4 sm:border-[6px] border-white dark:border-gray-900 shadow-xl flex items-center justify-center text-white font-bold text-sm sm:text-base">
//                 {index + 1}
//               </div>

//               <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-lg hover:-translate-y-2 hover:shadow-2xl transition duration-300 border border-purple-100 dark:border-gray-700">
//                 <div className="flex flex-wrap items-start justify-between gap-3 sm:gap-4">
//                   <div>
//                     <span className="inline-block text-xs sm:text-sm bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full font-semibold">
//                       {exp.duration}
//                     </span>

//                     <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mt-4 sm:mt-5 text-gray-900 dark:text-white">
//                       {exp.role}
//                     </h3>

//                     <h4 className="text-base sm:text-lg mt-1.5 sm:mt-2 text-gray-600 dark:text-gray-300">
//                       {exp.company}
//                     </h4>
//                   </div>

//                   {exp.current && (
//                     <span className="flex items-center gap-1.5 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full font-semibold text-xs sm:text-sm">
...
//                       <span className="text-purple-700 dark:text-purple-400 mt-1 flex-shrink-0">✔</span>
...
//   },
//   {
//     duration: "Jun 2023 – Jul 2023 · 1 month",
//     role: "Web Development Intern",
//     company: "Bharat Intern",
//     type: "Virtual Internship",
//     icon: <FiGlobe />,
//     achievements: [
//       "Worked on web development and designing tasks remotely.",
//       "Built and styled responsive web pages.",
//       "Collaborated effectively in a fully virtual internship setup.",
//     ],
//     current: false,
//   },
//   {
...
//     icon: <FiBriefcase />,
//     achievements: [
//       "Extracted and collected information from live websites through web scraping.",
//       "Converted raw scraped data into clean, usable formats.",
//       "Learned practical techniques and tools for web data extraction.",
//     ],
//     current: false,
//   },
// ];
...
//             From data extraction to full production React apps — five internships that shaped how I build.
//           </p>
//         </div>

//         {/* ===== Desktop: alternating zigzag timeline ===== */}
//         <div className="hidden lg:block relative">
//           <div className="absolute left-1/2 -translate-x-1/2 top-0 w-0.5 h-full bg-gradient-to-b from-purple-300 via-violet-300 to-transparent dark:from-violet-700/60 dark:via-blue-700/40"></div>
...
//                     <div
//                       className={`group bg-white dark:bg-white/5 border border-purple-100 dark:border-white/10 rounded-2xl p-6 shadow-md dark:shadow-none hover:-translate-y-1.5 hover:shadow-xl dark:hover:border-violet-500/40 transition-all duration-300 ${
...
//                         {exp.role}
//                       </h3>
//                       <h4 className="text-sm lg:text-base mt-1 text-purple-600 dark:text-violet-400 font-medium">
//                         {exp.company}
//                       </h4>
...
//                     <div className="w-12 h-12 rounded-full bg-gradient-to-br from-violet-700 to-purple-600 border-4 border-white dark:border-[#05060f] shadow-xl flex items-center justify-center text-white text-lg">
//                       {exp.icon}
//                     </div>
//                   </div>
...
//           {experiences.map((exp, index) => (
//             <div key={exp.company} className="relative pl-14 sm:pl-16 pb-10 sm:pb-12 last:pb-0">
//               <div className="absolute left-0 top-1 sm:top-2 w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-violet-700 to-purple-600 border-4 sm:border-[6px] border-white dark:border-[#05060f] shadow-xl flex items-center justify-center text-white text-sm sm:text-base">
//                 {exp.icon}
//               </div>

//               <div className="bg-white dark:bg-white/5 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-lg dark:shadow-none hover:-translate-y-1.5 hover:shadow-2xl dark:hover:border-violet-500/40 transition duration-300 border border-purple-100 dark:border-white/10">
...
//                       {exp.role}
//                     </h3>
//                     <h4 className="text-base mt-1.5 text-purple-600 dark:text-violet-400 font-medium">
//                       {exp.company}
//                     </h4>
//                     <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">{exp.type}</p>
//                   </div>
