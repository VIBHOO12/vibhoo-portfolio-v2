...
// const knowledgeBase = [
//   {
//     keywords: ["skill", "tech", "stack", "technology", "know", "language"],
//     answer: "Vibhoo works primarily with React.js, JavaScript, Tailwind CSS, Java, Spring Boot, MySQL and MongoDB. Frontend is her strongest area, with growing backend experience.",
//   },
//   {
//     keywords: ["experience", "work", "job", "intern", "company"],
//     answer: "She's currently a Frontend Developer Intern at Vithal Visions Pvt. Ltd. (Aug 2025 – Apr 2026), where she's built production React apps and integrated 18+ REST APIs. She previously interned at Infosys Springboard working with Angular.",
//   },
//   {
//     keywords: ["project", "portfolio", "built", "made"],
//     answer: "Some highlights: CineVestor Platform (entertainment investment app), a Medication Tracker (React + Spring Boot + MySQL), an AI Resume Analyzer, and a React Pong game. Check the Projects section above for live links and code!",
//   },
//   {
//     keywords: ["contact", "email", "reach", "hire", "connect", "phone"],
//     answer: "You can reach Vibhoo at vibhoovishwakarma@gmail.com or use the contact form below — she typically responds within 24 hours and is currently open to new opportunities.",
//   },
//   {
//     keywords: ["available", "open", "opportunit", "looking", "job search"],
//     answer: "Yes, she's currently available and actively looking for Frontend Developer / React.js Developer roles.",
//   },
//   {
//     keywords: ["resume", "cv", "download"],
//     answer: "You can download her resume using the button in the Hero or About section at the top of the page.",
//   },
//   {
//     keywords: ["education", "degree", "college", "study"],
//     answer: "For detailed education background, it's best to check her resume or ask her directly via the contact form — I have limited details on that here.",
//   },
//   {
//     keywords: ["react", "frontend"],
//     answer: "React.js is Vibhoo's core strength — she's built 25+ reusable components and has 9+ months of production experience with it.",
//   },
//   {
//     keywords: ["java", "backend", "spring"],
//     answer: "She has intermediate backend experience with Java and Spring Boot, including building secure REST APIs and working with MySQL databases.",
//   },
//   {
//     keywords: ["hello", "hi", "hey"],
//     answer: "Hi there! 👋 I'm Vibhoo's portfolio assistant. Ask me about her skills, experience, or projects!",
//   },
// ];

// const fallback =
//   "I don't have a specific answer for that yet, but you can ask about her skills, experience, projects, or how to contact her — or reach out directly through the contact form!";

// const suggestions = ["What are her skills?", "Is she available for hire?", "Tell me about her projects"];
...
//     { role: "bot", text: "Hi! I'm Vibhoo's AI assistant. Ask me anything about her skills, experience or projects." },
//   ]);
...
//         className="fixed bottom-5 right-5 sm:bottom-8 sm:right-8 z-40 w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r from-violet-700 to-purple-600 text-white shadow-2xl flex items-center justify-center hover:scale-110 transition-transform"
//       >
//         {open ? <FiX size={24} /> : <FiCpu size={24} />}
//         {!open && (
//           <span className="absolute top-0 right-0 w-3.5 h-3.5 rounded-full bg-green-400 border-2 border-white animate-pulse"></span>
//         )}
//       </button>

//       {/* Chat window */}
//       <div
//         className={`fixed bottom-24 right-4 sm:bottom-28 sm:right-8 z-40 w-[calc(100%-2rem)] sm:w-96 max-w-sm bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-purple-100 dark:border-gray-700 flex flex-col transition-all duration-300 origin-bottom-right ${
//           open ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-95 translate-y-4 pointer-events-none"
//         }`}
//         style={{ height: "min(520px, 70vh)" }}
//       >
//         <div className="flex items-center gap-3 p-4 sm:p-5 bg-gradient-to-r from-violet-700 to-purple-600 rounded-t-3xl">
//           <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-white">
//             <FiCpu size={20} />
//           </div>
//           <div>
//             <p className="text-white font-semibold text-sm sm:text-base">Ask about Vibhoo</p>
...
//               <div className="w-7 h-7 rounded-full bg-violet-700 text-white flex items-center justify-center flex-shrink-0">
//                 <FiCpu size={13} />
//               </div>
//               <div className="bg-purple-50 dark:bg-gray-700 px-4 py-3 rounded-2xl rounded-bl-sm flex gap-1">
...
//                 className="text-xs bg-purple-50 dark:bg-gray-700 text-purple-700 dark:text-purple-300 px-3 py-1.5 rounded-full hover:bg-purple-100 dark:hover:bg-gray-600 transition"
//               >
//                 {s}
//               </button>
//             ))}
...
//         <form onSubmit={handleSubmit} className="p-3 sm:p-4 border-t border-purple-100 dark:border-gray-700 flex items-center gap-2">
//           <input
//             type="text"
//             value={input}
//             onChange={(e) => setInput(e.target.value)}
//             placeholder="Ask a question..."
//             className="flex-1 bg-purple-50 dark:bg-gray-700 dark:text-white rounded-full px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-purple-400"
//           />
//           <button
//             type="submit"
//             aria-label="Send"
//             className="w-10 h-10 rounded-full bg-purple-700 text-white flex items-center justify-center hover:bg-purple-800 transition flex-shrink-0"
//           >
//             <FiSend size={16} />
//           </button>
//         </form>
